...
const requiredMutationMarkers = ["create or replace function public.korama_create_order", "create or replace function public.korama_verify_payment", "create or replace function public.korama_allocate_order_fefo", "create or replace function public.korama_advance_order", "create or replace function public.korama_command_sortie", "create or replace function public.korama_reset_demo", "delivery_address_snapshot", "shipments_status_check", "compliance_snapshot", "attributes jsonb", "grant execute on function public.korama_allocate_order_fefo(text) to service_role"];
