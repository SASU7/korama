...
const requiredMutationMarkers = ["create or replace function public.korama_create_order", "create or replace function public.korama_verify_payment", "create or replace function public.korama_allocate_order_fefo", "create or replace function public.korama_advance_order", "create or replace function public.korama_command_sortie", "delivery_address_snapshot", "shipments_status_check", "grant execute on function public.korama_allocate_order_fefo(text) to service_role"];
